    ...
    <div className={cn("fixed top-10 inset-x-0 z-50 max-w-md mx-auto bg-gradient-to-r from-black to-gray-800 p-2 py-1 rounded-lg shadow-sm", className)}>
      <Menu setActive={setActive}>
        <MenuItem setActive={setActive} active={active} item="Home">
          <Link href="/" onClick={() => setActive("Home")} className={`text-white text-base font-medium hover:text-gray-300 transition duration-300 ease-in-out ${active === "Home" ? "text-indigo-800" : ""}`}>
            Home
          </Link>
        </MenuItem>

        <MenuItem setActive={setActive} active={active} item="Our Courses">
          <Link href="/courses" onClick={() => setActive("Our Courses")} className={`text-white text-base font-medium hover:text-gray-300 transition duration-300 ease-in-out ${active === "Our Courses" ? "text-indigo-800" : ""}`}>
            Our Courses
          </Link>
        ...
        <MenuItem setActive={setActive} active={active} item="Contact">
          <Link href="/contact" onClick={() => setActive("Contact")} className={`text-white text-base font-medium hover:text-gray-300 transition duration-300 ease-in-out ${active === "Contact" ? "text-indigo-800" : ""}`}>
            Contact
          </Link>
        </MenuItem>
      </Menu>
